...
class UnalignedDataset(BaseDataset):
    ...
    def __init__(self, opt):
        ...
        self.dir_A = os.path.join(opt.dataroot, opt.phase, opt.folderA)  # create a path '/path/to/data/train/A'
        self.dir_B = os.path.join(opt.dataroot, opt.phase, opt.folderB)  # create a path '/path/to/data/train/B'
